...
If you use the fable package to make your forecasts, the default plot will display a confidence interval around your forecast. I enjoy this feature. In my previous post I discussed reasons people didn't visualise uncertainty, one of them being a refusal to "put their money where their mouth is". Inaction in the face of uncertainty is common, not visualising uncertainty because you aren't sure how to do it is just uncertainty about uncertainty. Default confidence intervals do not require users to understand and quantify the uncertainty, but it does force *something* to be put down in terms of quantifiable uncertainty. But what
