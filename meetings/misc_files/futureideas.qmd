...
- Since we cannot ask a deterministic question about a random variable since they depend on a probabiltiy, we could instead display uncertainty and ask open ended questions and how visualisation method and variance affect signal suppression (i.e. whether or not the participants notice the relationship).
