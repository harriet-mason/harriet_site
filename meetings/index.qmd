...
- (todo) Part 2 add a mathematical definition of uncertainty
- (todo) Part 2 example, work through a breakdown of uncertainty
- (todo) Part 3 example, compare the data-centred approach to the hypothesis approach

### Cassowaryr
- Tried and failed to install interp usig gitlab. Emailled Albercht with session info and hopefully he can find out what is causing the problem.

### Other Work
- (todo) Write abstract for Australian Statistical Conference poster and show next week
