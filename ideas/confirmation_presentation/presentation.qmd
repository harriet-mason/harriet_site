...
subtitle: "Harriet Mason"
bibliography: references.bib
author: "Supervisors: Di Cook, Sarah Goodwin, Emi Tanaka, and Ursula Laa"
format: 
  revealjs: 
...
There is a QR code with a URL floating around that you can and should use to join in on the quiz. This will be no fun if nobody answers it. Each question will get an explanation and then you will have 20 seconds to answer in the flux quiz.
:::
