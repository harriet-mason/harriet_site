...
- The plot on the right = the joint distribution of the classes + Bernouli distribution of event A>B
- How often is a student from Class A taller than a student from Class B?
...
- The plot on the right depicts the joint distribution of class A and B with colour highlighting the Bernouli distribution of interest
...
- Parameters are the statistics that are related to our distribution. The mean and variance are examples of parameters. Plots that show parameters are quite flexbile since they can depict almost anything, but usually the scope of each plot is limited.
...
:::
## A Real Highschool Story 
::: {style="font-size: 85%;"}
When I was in high school we had to do very precise scientific experiments with pretty shotty equipment, so it wasn't unusual to get results that were all over the place. 
:::

## A Real Highschool Story 
::: {style="font-size: 85%;"}
When I was in high school we had to do very precise scientific experiments with pretty shotty equipment, so it wasn't unusual to get results that were all over the place. Additionally we weren't allowed to use "shotty equiptment" to explain why our results that went against all scientific wisdom. 
:::

## A Real Highschool Story 
::: {style="font-size: 85%;"}
When I was in high school we had to do very precise scientific experiments with pretty shotty equipment, so it wasn't unusual to get results that were all over the place. Additionally we weren't allowed to use "shotty equiptment" to explain why our results that went against all scientific wisdom. This meant bad luck with your experimental results could result in a terrible grade. 
:::
...
- or we could highlight different parameters
:::
...
::: {.notes}
- For example, here is a visualisation of a hypothesis test where we are testing if the pink distribution is significantly different from the black distribution
...
::: {.notes}
Now we can move on to our third and quiz question and classification
:::
...
::: {.notes}
So that is the taxonomy of visualisation, and the end of the quiz and Chapter 1. Congratulations you guys are ___ smarter than a big 4 consultant. 
:::
