...
- [ ] Full read over with changes needed to:
...
#### Tuesday
- [ ] Work out why Vizumap plots stoppped working :(
- [ ] Add HOPs plot to example
- [ ] Fix formatting of plots (PDF / individual figure sizes / figures on pages by themselves)
