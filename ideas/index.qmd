...
#### Monday
- [x] Question 2: Decisions Under Certainty
- [x] Question 3: Decisions Under Uncertainty
- [x] Formatting of slides
- [x] Draw apples and oranges icon

#### Tuesday
- [x] Tidy up Question 3
- [x] Plan out all slides
- [x] Question 4: Visualising a Distribution
- [x] Swap the two tram tracker distributions
- [x] Add icon to slides
- [x] Question 5: A Bad Distribution
- [x] Question 6: A Good Distribution
- [x] Put in slide numbers
- [X] Add countdown timer for each quiz question
- [x] Question 7: The Error Bar Problem
- [x] Set up quiz for Sophie to give out

#### Wednesday
- [x] Spell Check
- [x] Check/fix speaker notes + incremental lists
- [x] Question 8: A Questionable Hierarchy
- [x] Serious Section 
- [x] Make logo bigger
- [x] Full read through and edit
- [x] Add in consultant responses
- [x] Print QR code so people can hand it around and join the quiz
- [ ] Full Read through and time
- [ ] Cut to time
- [ ] Present @4pm

### Additional PRESENTATION ideas
- Have tally on board for consultants vs academics
