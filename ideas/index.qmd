...
listing:
  - id: part1
    type: grid
    contents: why_visualise_uncertainty/index.qmd
    fields: [image, title]
  - id: part2
    type: grid
    contents: what_is_uncertainty/index.qmd
    fields: [image, title]
  - id: part3
    type: grid
    contents: uncertaintyisdecisions/index.qmd
    fields: [image, title]
  - id: ideas
    type: grid
    contents: ideadumpster/index.qmd
    fields: [image, title]
---
# Overview of Topic
...
### Part 1: Why People Don't Visualise
...
### Part 2: Defining Uncertainty
This part zooms in on the difficulties of quantifying and measuring uncertainty by giving a susinct typology of uncertainty. I ask where uncertainty comes from, how we quantify it, what we do when we cant, and how the sources of uncertainty might impact the visualisation. I provide an example of how to define uncertainty with an example of forecast uncertainty.

::: {#part2}
:::

### Part 3: Defining the Purpose
Here I reject the idea of uncertainty being tied to the type of data it comes from and instead show why it should be connected to a hypothesis. I provide evidence in the literature of this perspective and show the problems associated with designing uncertainty visualisations that do not have a specific hypothesis in mind. I make clear that asking which visualisation method is best for visualising uncertainty is fundamentally removed from the way people engage with the problem. 
