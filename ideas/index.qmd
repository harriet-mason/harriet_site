...
- Supervisor Comments:
  ...
  - [x] Move casswaryr to sections at the end of the report called "additional activity"
  - [x] Add 3 month break to timeline
  - [ ] Cut fable package section on page 5
  - [ ] Cut chatper 3 discussing of random pacakge
  - [ ] Fix captions to follow structure
  - [ ] Move why section to begining section
  - [ ] Reference anscombes quartet in last section because it is contradictory to 
  - [ ] Add in "how to read section" that explains the stage of the work being presented and how the report is structured
  - [ ] Chapter 1 give another explanation of coming structure
- [ ] Final read over + spell check

### Add if I have time for some reason (but probably not)
- I couldnt find a citation for “show me the data”. Check again later?
- gestalt principles?
