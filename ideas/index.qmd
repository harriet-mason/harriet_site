...
- [ ] 3 Motivation Questions + speaker notes
- [ ] 2 Distribution Questions + speaker notes
- [ ] 2 Feature Questions + speaker notes
- [ ] 2 Distribution Questions + speaker notes

#### Monday
- [ ] 1 Conclusion Question + speaker notes
- [ ] Serious Section + speaker notes
- [ ] Reherse Speech
- [ ] Figure out quiz software
- [ ] Set up slide themes
- [ ] Set up quiz for Sophie to give out

#### Tuesday

## Additional notes (or vis ideas)
