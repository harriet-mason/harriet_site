...
#### Tuesday
- [ ] Add HOPs plot to example
- [ ] Fix formatting of plots (PDF / individual figure sizes)
- [ ] Why are the added in images appearing on pages by themselves? Fix that somehow :(
- [ ] I need to have the plots at a consistent size that isnt *touching* :(
- [ ] Add in sufficiency link (short one sentence)
- [ ] Check circle error bar is accurate
- [ ] Full read over of current work + spell check

#### Wednesday
- [ ] Full read over of current work + spell check

### Low Priority Maybes (If time but probably not)
- gestalt principles?
