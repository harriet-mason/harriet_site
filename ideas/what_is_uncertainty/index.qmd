...
When we try an apply the typology to a visualisation we have already created, we run into a small problem. We seem to have visualised the uncertainty backwards. If you read the details of the typology, it seems to suggest that we are deciding on what the scope of our project and then finding data that fits that scope. While this may occasionally be true, very often we let our data decide the scope of our decisions.
