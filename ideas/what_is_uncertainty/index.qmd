...
If you ask me where, in the interconnected web of definitions uncertainty is introduced, I would say right at the start, when we define the sample space. If your sample space for whatever system or variable you are considering has more than one outcome, then we have some level of uncertainty. The things that follow afterwards, probability spaces, random variables, decision theory, etc help us quantify and describe uncertainty, but they are not uncertainty in of themselves.

### Common Terminology Definition
I think it is fair to say that most papers don't use the mathematical definition of uncertainty. Going into the fine details of measure theory and decision seems like a bit of overkill, however landing somewhere between a well accepted rigorous mathematical definition and a seemingly infinite number of difficult to pin down definitions would have been nice.
