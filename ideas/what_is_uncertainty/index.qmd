...
This definition has a few follow up implications for uncertainty. 

First of all, it establishes that uncertainty is not a thing in of itself, but rather a property that some variable can have (lets call this variable X). 

Second of all, this property is related to our knowledge about X, rather than a comment on X itself. This allows the definition of uncertainty to diverge from the definition of randomness which is because a system can be deterministic, not random, but if we have incomplete knowledge of this deterministic event, it is uncertain. 

Third of all this definition does not speak to a general uncertainty, you have to specify the "relevant system". I think of this as identifying the random variable we are dealing with. 

Third, this definition does not tie uncertainty to a anything except a set of potential outcomes. 
