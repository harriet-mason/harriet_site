...
```
The error bar plot and the violin plot in @fig-examples depicted a distribution, the scatter bar plot and slopegraph in @fig-alternatives depicted the relationship between Solution A and Solution B concentrations, the stacked and normal bar plots represented proportions. The two plots that visualised the distribution depict the two concentrations as two independent random variables with little concern to their relationship. The two relationship plots highlighted that what we care about is actually care about is the relationship, and the colour highlighted the question (is A bigger than B) as something of secondary interest. These depitions still maintain some information about the distribution (you can tell that we seem to have to have two independent normal distributions) however it is no longer of primary importance. The stacked bar chart highlighted that the proportion is the aspect of the data we care about, while the normal bar chart highlighted that the difference in the two proportions is of primary importance. Any depiction of the distribution has been removed. 
