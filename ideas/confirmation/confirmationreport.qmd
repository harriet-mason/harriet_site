...
#|   - "Error bar plot"
#|   - "Violin plot"
#| fig-cap: "Replicate of two plot given in [@Hullman2015] to show the graphics participants were shown. The example question provided with this plot was 'In what percentage of vials is there more of solute B than A (Probability(B > A)?'"
#| layout-ncol: 2
