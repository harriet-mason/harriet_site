...
Four spatial uncertainty visualisations that can be made using the `Vizumap` package. These maps are the example visualisations from the package vignette.
:::
