...
The paper focuses on the discrete case
...
While the authors leave discussions of the associated R package until the end, I am going to discuss it throughout. My reason for this is two-fold 1) The structure of the package is helpful in understanding how the product plot breakdown should work, and 2) The plots that are made with the package are used throughout the paper and it is easier to understand how the package works when shown along the visualisations it created
