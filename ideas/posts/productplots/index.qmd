...
#| label: fig1
#| echo: false
#| fig-cap: "Replication of figure 1 from the paper. The last two plots are made by utilising the level argument."
...
#| label: fig3
#| echo: false
#| fig-cap: "Recreation of Figure 3 that shows fluct size and NA identification. I was unable to get the NA identification plot to look identical to the one in the paper."
...
```{r}
#| fig-cap: Replication of Figure 7
#| echo: false
#| fig-cap: "Replication of Figure 7 from the paper. While the first plot appears in my summary, the second does not. I included both here for the sake of completeness. Continuous histograms are particularly difficult using the product plots framework since a new function needs to be defined to allow the bars to touch."
...
```{r}
#| echo: false
#| fig-cap: "Replication of Figure 6."

# Fig 6
# plot 1
p1 <- prodplot(happy_clean, ~ marital, c("hspine")) + 
  aes(fill=marital) +
  scale_fill_brewer() +
  theme(legend.position = "none",
        aspect.ratio = 1,
...
marital_breaks2 = as.vector(y - 0.5*x)
  # plot
p2 <- prodplot(happy_clean, ~ sex + marital, c("hspine", "hspine")) + 
  aes(fill=sex) +
...
```{r}
#| eval: false
#| fig-cap: Replication of Figure 8
...
```{r}
#| eval: false
#| fig-cap: Replication of Figure 9
...
```{r}
#| eval: false
#| fig-cap: Replication of Figure 10
...
```{r}
#| eval: false
#| fig-cap: Replication of Figure 11
...
```{r}
#| eval: false
#| fig-cap: Replication of Figure 12
