...
# Fig 3
# Plot 1
age_breaks = paste("(", seq(10,80,10), ",", seq(20,90,10), "]", sep="")
marital_breaks = c("married", "never married", "divorced", "widowed", "separated")
happy_clean %>%
...
happy_clean %>%
  prodplot(~ 1 | health + year, c("vspine", "hspine")) +
  aes(fill=health)
...
prodplot(happy, ~ happy | sex + health, mosaic("h")) +
  aes(fill=happy)
```
## 1 Introduction
