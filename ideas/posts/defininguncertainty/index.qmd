...
- Thinking about that thing where you want a validation set that is your final error. There is a relationship between the value of your data and what you use it for. Like low level is EDA, higher is assumption check, final level is using it for regularisaton.
- imputing missing values is literally doing a model. How does a misaligned model at a lower level affect higher level. It is an assumption but also data.
